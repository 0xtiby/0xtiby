...
**Full stack developer & web3 builder based in France.**

[![Website](https://img.shields.io/badge/tibyverse.xyz-000?style=flat-square&logo=vercel&logoColor=white)](https://tibyverse.xyz)
[![Twitter](https://img.shields.io/badge/@0xTiby-000?style=flat-square&logo=x&logoColor=white)](https://x.com/0xTiby)
[![GitHub](https://img.shields.io/badge/@0xtiby-000?style=flat-square&logo=github&logoColor=white)](https://github.com/0xtiby)

---

I build products at the intersection of web development, blockchain, and AI tooling. Node.js/React developer by day, Solidity tinkerer by night. I like shipping things fast and writing about what I learn along the way.
...
- **[parse-server-otp-auth-adapter](https://github.com/0xtiby/parse-server-otp-auth-adapter)** -One-time password auth adapter.
- **[parse-server-x-auth-adapter](https://github.com/0xtiby/parse-server-x-auth-adapter)** -X (Twitter) auth adapter.
- **[parse-server-resend-adapter](https://github.com/0xtiby/parse-server-resend-adapter)** -Email adapter for Resend.
- **[parse-server-rainbowkit-auth](https://github.com/0xtiby/parse-server-nextjs-rainbowkit-authentication)** -RainbowKit authentication adapter.
